...
async def get_dynamic_pool_size():
    ...
    MIN_POOL_SIZE = 5    # Start conservatively 
...
# Schedule periodic adjustments every 100 seconds
scheduler.add_job(adjust_pool_size, "interval", seconds=100)
scheduler.start()    
...
async def process_blocks(start_block, end_block, batch_size=200, max_concurrent_batches=5, retries=5):
    ...
    MIN_CONCURRENT_BATCHES = 5    # Lower limit
