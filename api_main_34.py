...
from quart import Response, jsonify, make_response, Quart, render_template, request, flash, redirect, url_for, send_file
...
async def fetch_swap_contract_transactions(contractName, contractAddress, transactionHash=None, USE_ASYNC=True):
    """
