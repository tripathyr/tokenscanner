...
def slim_raw_transaction_json(raw_json_str):
    try:
        ...
        def slim_vout(v):
            ...
            return {
                "value": v.get("value"),
                "addresses": addresses,  # for calculate_balance_and_update
                "scriptPubKey": {
                    "addresses": addresses  # for process_all_transactions_for_coinbase and rollback
                }
            }
        ...
        return raw_json_str  # Fallback to original if anything fails
