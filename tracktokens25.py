...
blockbook_neturl_list = config['DEFAULT']['BLOCKBOOK_NETURL'].split(',')
try:
    neturl = initialize_neturl(blockbook_neturl_list)
except Exception as e:
    print(f"Initialization failed: {e}")
    neturl = None  # Handle initialization failure appropriately
