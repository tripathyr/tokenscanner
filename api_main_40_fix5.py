        ...
        try:
            ...
            if is_internal:
                transactions_object = {
                    ...
                    'tokenIdentification': row['token'] or parsedFloData.get('tokenIdentification') or parsedFloData.get('token') or 'unknown',
                ...
                if row['transactionType'] == 'smartContractIncorporation':
                    transactions_object.update({
                        ...
                        'floData': parsedFloData.get('floData') or parsedFloData.get('floData'),
                        'contractAddress': parsedFloData.get('contractAddress'),
                        ...
                        'tokenAmount': 0.0,
                        'tokenIdentification': parsedFloData.get('tokenIdentification') or 'unknown'
                    })
            ...
            # 🧠 Inject selective fields only for continuous-event contracts
            if contractStructure and contractStructure.get('contractType') == 'continuous-event':
