    ...
    try:
        async with await get_mysql_connection(token_db_name, USE_ASYNC=USE_ASYNC) as conn_token, \
            ...
            async with conn_sc.cursor(DictCursor) as cursor_sc, conn_token.cursor(DictCursor) as cursor_token:
                ...
                sc_transactions = list(await cursor_sc.fetchall())  # ✅ Ensure list
                ...
                token_transactions = list(await cursor_token.fetchall())  # ✅ Ensure list
...
async def fetch_contract_transactions(contractName, contractAddress, _from=0, to=100, USE_ASYNC=True):
    ...
    try:
        ...
        async with conn_sc.cursor() as cursor_sc:
            ...
            creation_tx = list(await cursor_sc.fetchall())  # ✅ Ensure list
        ...
        if contractStructure['contractType'] == 'continuos-event':
            ...
            transactionJsonData.extend(list(transaction_results_token1))  # ✅ Ensure list
            transactionJsonData.extend(list(transaction_results_token2))
            ...
            transactionJsonData.extend(list(result))  # ✅ Ensure list
