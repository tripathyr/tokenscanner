...
from models import (
    ...
    ContractBase, ContractDeposits, ContractDeposits2, ContractParticipants,
    ContractParticipants2, ContractStructure, ContractStructure2,
    ContractTransactionHistory, ContractTransactionHistory2, ContinuosContractBase,
...
def update_dynamic_swap_price(session, price, timestamp, blockheight):
    ...
    record = session.query(ContractStructure2).filter_by(attribute="dynamicPriceUpdate").first()
    ...
    if record:
        ...
        record.blockNumber = blockheight
            ...
            session.add(ContractStructure2(
