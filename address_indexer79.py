...
async def process_blocks(start_block, end_block, batch_size=1000, max_concurrent_batches=10, retries=5):
        ...
        async with semaphore:
            ...
            try:
                async with conn.cursor() as cursor:
                    ...
                    await cursor.execute(
                        "INSERT INTO processed_blocks (block_height, block_hash) VALUES (%s, %s) "
